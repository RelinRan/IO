...
public class CircleProgress extends View {
    ...
    private void initAttributeSet(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            progressColor = context.getResources().getColor(R.color.io_circle_progress_color);
            ...
            textColor = context.getResources().getColor(R.color.io_circle_progress_text_color);
