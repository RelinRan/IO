...
import androidx.io.core.StatusBar;
import androidx.io.media.Media;
import androidx.io.media.MediaProvider;
import androidx.io.media.MediaAdapter;
import androidx.io.media.MediaExecutor;
import androidx.io.media.OnMediaItemClickListener;
import androidx.io.media.PopMenu;
import androidx.io.media.PopMenuWindow;
...
public class MediaActivity extends AppCompatActivity implements View.OnClickListener, OnMediaItemClickListener, TextWatcher {
    ...
    protected int[] MENU_ICONS = {
            R.mipmap.io_card_icon,
            R.mipmap.io_image_icon,
            R.mipmap.io_move_icon,
            R.mipmap.io_audio_icon
    };
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.io_media);
