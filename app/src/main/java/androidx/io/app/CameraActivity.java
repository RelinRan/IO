...
import androidx.io.core.CameraOptions;
import androidx.io.core.CameraProvider;
import androidx.io.R;
import androidx.io.core.UriProvider;
import androidx.io.video.VideoRecorder;
...
public class CameraActivity extends AppCompatActivity implements View.OnClickListener, VideoRecorder.OnVideoTimerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.io_video_record);
    ...
    private void initialize() {
        ...
        //拍照按钮
        startView.setImageResource(isCapture() ? R.mipmap.io_capture : R.mipmap.io_record_start);
        //时间
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.iv_flash) {
            ...
            flashView.setImageResource(CameraProvider.isFlashOff(camera) ? R.mipmap.io_flash_on : R.mipmap.io_flash_off);
        }
    ...
    protected void toggleRecord(boolean start) {
        if (start) {
            ...
            startView.setImageResource(R.mipmap.io_record_stop);
            if (recorder != null) {
                recorder.start();
            }
        } else {
            ...
            startView.setImageResource(R.mipmap.io_record_start);
            if (recorder != null) {
                recorder.stop();
            }
        }
    ...
    public void onVideoTimer(long millis) {
        ...
        int dot = millis % 2 == 0 ? R.drawable.io_record_red_dot : R.drawable.io_record_white_dot;
