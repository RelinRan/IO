...
import androidx.io.core.ImageProvider;
import androidx.io.R;
import androidx.io.core.UriProvider;
import androidx.io.app.TBSActivity;
import androidx.io.video.VideoProvider;
...
public class MediaProvider {
    ...
    public static Bitmap getIcon(Context context, File file) {
        ...
        if (file.isDirectory()) {
            return BitmapFactory.decodeResource(resources, R.mipmap.io_dir);
        } else {
            ...
            if (isDoc(suffix)) {
                return BitmapFactory.decodeResource(resources, R.mipmap.io_doc);
            }
            if (isPPT(suffix)) {
                return BitmapFactory.decodeResource(resources, R.mipmap.io_ppt);
            }
            if (isPPT(suffix)) {
                return BitmapFactory.decodeResource(resources, R.mipmap.io_bat);
            }
            if (isXLS(suffix)) {
                return BitmapFactory.decodeResource(resources, R.mipmap.io_xls);
            }
            if (isPDF(suffix)) {
                return BitmapFactory.decodeResource(resources, R.mipmap.io_pdf);
            }
            if (isDB(suffix)) {
                return BitmapFactory.decodeResource(resources, R.mipmap.io_db);
            }
            if (isBat(suffix)) {
                return BitmapFactory.decodeResource(resources, R.mipmap.io_bat);
            }
            if (isTXT(suffix)) {
                return BitmapFactory.decodeResource(resources, R.mipmap.io_txt);
            }
            if (isHtml(suffix)) {
                return BitmapFactory.decodeResource(resources, R.mipmap.io_html);
            }
            if (isJson(suffix)) {
                return BitmapFactory.decodeResource(resources, R.mipmap.io_json);
            }
            if (isXml(suffix)) {
                return BitmapFactory.decodeResource(resources, R.mipmap.io_xml);
            }
            if (isContact(suffix)) {
                return BitmapFactory.decodeResource(resources, R.mipmap.io_vcf);
            }
            if (isCompression(suffix)) {
                return BitmapFactory.decodeResource(resources, R.mipmap.io_zip);
            }
            if (isAudio(suffix)) {
                return BitmapFactory.decodeResource(resources, R.mipmap.io_music);
            }
            return BitmapFactory.decodeResource(resources, R.mipmap.io_none);
        }
    }
